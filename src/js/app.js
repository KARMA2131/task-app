...
const [...users] = tasks;
//----------------------Добавление Имеющихся Tasks-----------------//
(function(arrOfTasks) {
//создать обьект обьектов из массива
...
listContainer.addEventListener('click', complatedButtonEv);
...
themeSelect.addEventListener('change', onThemeSelect)
  ...
  deleteBtn.textContent = '✕';
    ...
    li.appendChild(complatedButton);
    return li;
  }
  ...
  function onFormSubmitHandler(e){
    ...
    if(!titleValue || ! bodyValue){
      console.error('Wrong Title Or Body');
      return;
    }
...
const newTask = {
  ...
  function complatedButtonEv({target}){
 if(target.classList.contains('complated-task-button')){
...
//   const isConfirmed = confirm(`Change theme to ${selectedTheme}`);
